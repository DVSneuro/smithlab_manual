...
Trello organizes tasks that need to be done (and relevant discussions, with the help of Slack\footnote{\url{https://trello.com/platforms/slack}}) for specific projects, rather than general principles. The OSF wikis provide detailed, step-by-step guides on how to get things done---both general things in the lab (e.g., how to use BIDS apps) and specific things tied to your project (e.g., how to run participants on this task). Any information that is potentially private or sensitive should go in a protected location. (You can read more about various lab resources in \Sref{sec:communicationInLab} on \pref{sec:communicationInLab}.)
...
\item When you add your project to our Project component, use a short (but unique name), ideally one that matches your GitHub repository (e.g., "Deception.01"). Within your project, you should have a public Home wiki that briefly describes the project and any hidden/private pages. You should also create subcomponents corresponding to most of the ones listed on the \href{https://osf.io/sesm4/}{JHU Lab Notebook Template} (you do not need a Data Management Plan or Standard Operating Procedures since those would be general to the Smith Lab). Each subcomponent can have its on integrations/add ons (e.g., Mendeley for your Literature subcomponent; GitHub for your Analysis subcomponent) as well as its own wiki(s).

\item In your "Manuscripts, Reports, Visual Presentations"\footnote{This name may change. Please see the wiki up to date information} subcomponent (e.g., SmithLab/Projects/Deception.01/PreprintsPosters) you will have this subcomponent set as a public page that stores finished products like posters, talks, and links to submitted preprints. 
...
% add stuff about Gopen, Pinker, Pelli style, and writing. There's also that PloS Biology paper I sent to the lab. All of those should be referenced here. 
